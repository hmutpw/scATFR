...
#####
#' @export
setGeneric("diffRegulons", function(x, ...) standardGeneric("diffRegulons"))
#' @export
setMethod("diffRegulons", c("SingleCellExperiment"), function(x){
  diff_regulon <- altExp(x)@metadata$scATFR$diffRegulons
  if(is.null(diff_regulon)) stop("No differential regulons found in your object, ",
                                 "please run cellTypeSpecific() first!")
  diff_regulon
  })
#' @export
setGeneric("diffRegulons<-", function(x, value) standardGeneric("diffRegulons<-"))
#' @export
setMethod("diffRegulons<-", "SingleCellExperiment", function(x, value){
  altExp(x)@metadata$scATFR[['diffRegulons']] <- value
  x
  })
